...
(defn transfer [call too options]
  ...
  (let [options          (or options {})
    ...
    (try (let [call  (make-tropo-call (.transfer (:_call_ call) too caller-id answer-on-media timeout play-value play-repeat choices))
